  ...
  return (
    ...
    <div className="w-[400px]  h-screen flex flex-col items-center justify-center">
      ...
      <div id="card" className={`${cardClass}`} onClick={toggleCard}>     
        <div id="card-inside">
          <div className="wrap">
            <p>happy birthday, vira andini!</p>
            <p>hari ini adalah hari istimewamu, semoga segala kebahagiaan dan keceriaan menyertai setiap langkahmu di usia yang baru ini.</p>
            <p>
              Pesan: <br />
              Terima kasih selama ini udah nemenin aku, semoga kedepannya vira bahagia terus walau udah gaada aku lagi.
            </p>
            <p>
             Jangan lupain aku ya vira, aku masih ada disini kalau vira butuh apa-apa.
            </p>
            <p>
              abang sayang vira ❤
            </p>
            <p className="signed">iyo.-</p>
          </div>
        </div>
